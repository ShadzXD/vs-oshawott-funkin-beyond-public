...
class Backstage extends BaseStage
{
	...
	override function create()
	{
        ...
        var stageBack:BGSprite = new BGSprite('backgrounds/backstage/backDark', 729, -170, 1, 1);
		stageBack.scale.set(1, 1);
        //stageBack.updateHitbox();
		stageBack.alpha = 1;

        var brightLightSmall:BGSprite = new BGSprite('backgrounds/backstage/brightLightSmall', 967, -103, 1.2, 1.2);
        ...
        var stageFront:BGSprite = new BGSprite('backgrounds/backstage/bg', -603, -187, 1, 1);
		stageFront.scale.set(1, 1);
        //stageFront.updateHitbox();
		stageFront.alpha = 1;

        var server:BGSprite = new BGSprite('backgrounds/backstage/server', -361, 205, 1, 1);
		server.scale.set(1, 1);
        //server.updateHitbox();
		server.alpha = 1;

        var light:BGSprite = new BGSprite('backgrounds/backstage/lights', -601, -147, 1.2, 1.2);
		light.scale.set(1, 1);
        //light.updateHitbox();
		light.alpha = 1;

        var orangeLight:BGSprite = new BGSprite('backgrounds/backstage/orangeLight', 189, -195, 1, 1);
		orangeLight.scale.set(1, 1);
        //orangeLight.updateHitbox();
		orangeLight.alpha = 1;

        var lightgreen:BGSprite = new BGSprite('backgrounds/backstage/lightgreen', -171, 242, 1, 1);
		lightgreen.scale.set(1, 1);
        //lightgreen.updateHitbox();
		lightgreen.alpha = 1;

        var lightred:BGSprite = new BGSprite('backgrounds/backstage/lightred', -101, 560, 1, 1);
		lightred.scale.set(1, 1);
        //lightred.updateHitbox();
		lightred.alpha = 1;

        var lightAbove:BGSprite = new BGSprite('backgrounds/backstage/lightAbove', 804, -117, 1, 1);
